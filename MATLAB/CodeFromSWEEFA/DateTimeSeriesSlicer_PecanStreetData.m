function [ OriginalSeries,StartIndex,EndIndex ] = DateTimeSeriesSlicer_PecanStreetData(OriginalDataSeries,SeriesNum3,Res,StartYear,EndYear,StartMonth,EndMonth,StartDay,EndDay,StartTime,EndTime)
...
try
    ...
    warning('DateTimeSlicer Function encountered an error. OriginalDataSeries = String');
    
    OriginalSeries= 'Error';
